...
folder <- paste0(paste0(which_year, "/"), paste0(which_year, "-week-"), formatC(which_week, width = 2, flag = "0")) 
...
file.create(readme)
readme_text <- paste0(
   "https://github.com/rfordatascience/tidytuesday/tree/master/data/2022/", next_tuesday, "\n\n![](plots/",
   newscript,
   ".png)")
