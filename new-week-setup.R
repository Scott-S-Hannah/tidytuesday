...
readme_text <-
   paste0('\n',
      ...
      '(', folder, ')',
      "\n\n",
      "Data: https://github.com/rfordatascience/tidytuesday/tree/master/data/",
      which_year,
      "/",
      next_tuesday,
      "\n",
      '[R Code here](', folder, "/", newscript, ".R)",
      "\n\n![](plots/",
      newscript,
      ".png)"
   )
...
# add info to main readme at top level
write(as.character(readme_text), file = "README.md", append = TRUE)
...
script_text <- paste0(
   ...
   '")',
   '\n\n\n',
   'ggsave("', folder, '/plots/',newscript, '.png"', ', plot = plot, dpi = 320, width = 8, height = 6)'
)
